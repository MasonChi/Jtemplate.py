...
from mysql.mysql_param import MySQLParam
...
def _build_entity_import(attrs):
    ...
    try:
        ...
        packageset = set()
        for attr in attrs:
            with open("../templates/entity.package.template") as packagef:
...
def _build_entity_property(attrs):
    ...
    try:
        properties = ''
        for attr in attrs:
            with open("../templates/entity.property.template") as propertyf:
...
def _build_entity_setter_getter(attrs):
    ...
    try:
        setter_getter = ''
        for attr in attrs:
            with open("../templates/entity.getset.template") as setgetf:
...
def product_entity(mysql_param, project_name, entity_name, creator=None, create_date=now):
    ...
    try:
        with open("../templates/entity.template") as entityf:
...
def product_example(project_name, entity_name, creator=None, create_date=now):
    ...
    """
    try:
        with open("../templates/example.template") as examplef:
...
def product_service(project_name, entity_name, creator=None, create_date=now):
    ...
    """
    try:
        with open("../templates/service.template") as servicef:
...
def product_service_impl(project_name, entity_name, creator=None, create_date=now):
    ...
    """
    try:
        with open("../templates/service.impl.template") as serviceimplf:
...
def product_mapper(project_name, entity_name, creator=None, create_date=now):
    ...
    """
    try:
        with open("../templates/mapper.template") as mapperf:
...
def product_mapper_xml(project_name, entity_name, table):
    ...
    """
    try:
        with open("../templates/mapper.xml.template") as mapperxmlf:
